...
* Research spells: This activity may only be taken in the base. Schoolmages may research new spells. Each week, the Schoolmage rolls the respective skill check against the difficulty of the target spell. If the skill check result is Superb (+3), then the Schoolmage obtains the spell.
